...
.. datafile:: baby1990_en.html
    :fromfile: ./_static/baby1990.html
    :hide:

.. datafile:: baby1996_en.html
    :fromfile: ./_static/baby1996.html
    :hide:

.. datafile:: baby2002_en.html
...
.. activecode:: ret04_en
    ...
    def main():
        print (extract_names('baby1990_en.html'))
    ...
    class myTests(TestCaseGui):
        ...
        def testOne(self):
            ...
            self.assertEqual(extract_names('baby1996_en.html'),answer1996)
        ...
        def testTwo(self):
            ...
            self.assertEqual(extract_names('baby2002_en.html'),answer2002)
...
Original exercise can be found at `Google Baby Names Exercise <https://developers.google.com/edu/python/exercises/baby-names?hl=en>`__.
