...
.. raw:: html
   ...
   <script id="create-db-script", query="", result="", flag="0">
      config = {
...
.. activecode:: ac_l42_1
    ...
    # función personalizada para imprimir datos en formato tabular
    ...
    # imprimir los datos
    # Se ha predefinido la función formato_datos para imprimir el resultado en formato tabular
    if(linhas!=None):
       formato_datos(linhas, 30)
    ...
    class myTests(TestCaseGui):
          def testOne(self):
             ans = {"columns":["id","nombre","pais","media","estilo","edad"],"values":[[102,"Juan Martino","Spain",9.01,"Gun",36],[106,"Zack 'bonnie-lad' MacFadden","Scotland",7.82,"Thruster",26]]}
